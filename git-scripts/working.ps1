# Lazy Load Git Working Function
$LazyWorkingFunction = {
    function working {
        ...
        try {
            ...
            Remove-Item Function:\working -ErrorAction SilentlyContinue
            return
        }
    ...
    # Register function after first execution
    Set-Item Function:\working ${function:working}
    working @args
}

# Register the function
Set-Item Function:\working $LazyWorkingFunction
